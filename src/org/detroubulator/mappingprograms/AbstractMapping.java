...
/**
 * This class serves as the abstract base class for Java, Message and XSL Mappings
 */
abstract class AbstractMapping implements MappingProgram {

    private XIServer server;

    public void setServer(XIServer server) {
        if (server == null) {
            throw new NullPointerException("Null parameter: server");
        }
        this.server = server;
    }
    ...
    public boolean canExecute() {
        return isConfigured() && (server != null);
    }
